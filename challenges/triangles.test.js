...
describe('test the triangle class', () => {
  test('test isosceles', () => {
    expect(Triangle(3, 3, 5)).toBe('isosceles triangle');
  });

  test('test scalene', () => {
    expect(Triangle(3, 4, 5)).toBe('scalene triangle');
  });

  test('test equilateral', () => {
    expect(Triangle(3, 3, 3)).toBe('equilateral triangle');
  });

  test('invalid triangle', () => {
    expect(Triangle(3, 3, 7)).toBe('invalid triangle');
  });

  test('invalid triangle', () => {
    expect(Triangle('s', 3, 4)).toBe('invalid triangle');
  });
});
...
describe("Triangle", () => {
  test("equilateral triangles have equal sides", () => {
    ...
    expect(Triangle(2, 2, 2)).toEqual("equilateral triangle");
  });

  xtest("larger equilateral triangles also have equal sides", () => {
    const triangle = new Triangle(10, 10, 10);
    expect(triangle.kind()).toEqual("equilateral triangle");
  });
